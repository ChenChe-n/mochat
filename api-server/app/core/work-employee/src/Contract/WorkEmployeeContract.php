 ...
 */
namespace MoChat\App\WorkEmployee\Contract;

interface WorkEmployeeContract
{
    /**
     * 查询单条 - 根据ID.
     * @param int $id ID
     ...
     * 查询多条 - 根据公司ID和成员微信ID.
     */
    public function getWorkEmployeeByCorpIdWxUserIds(int $corpId, array $wxUserId, array $columns = ['*']): array;

    /**
     * 修改单条 - 根据CorpIdWxUserId.
     * @return int 修改条数
     */
    public function updateWorkEmployeeByCorpIdWxUserId(int $corpId, string $wxUserId, array $columns = ['*']): int;

    /**
     * 查询多条 - 根据成员id和存档状态.
     * @param array $id 企业ID
     * @param int $auditStatus 存档状态
     * @param array|string[] $columns 查询字段
     * @return array 数组
     */
    public function getWorkEmployeesByIdAuditStatus(array $id, int $auditStatus, array $columns = ['*']): array;
     ...
     * @return array 数组
     */
    public function getWorkEmployeeByIdWithTrashed(int $id, array $columns = ['*']): array;
